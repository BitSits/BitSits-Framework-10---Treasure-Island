...
namespace BitSits_Framework
{
    class MessageBoxScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ScreenManager.FadeBackBufferToBlack(TransitionAlpha * 0.75f);
            ...
            if (text != null)
            {
                ...
                spriteBatch.DrawString(font, text, new Vector2(350, 320), color, 0, Vector2.Zero,
                    40.0f / ScreenManager.GameContent.gameFontSize, SpriteEffects.None, 1);
            }
